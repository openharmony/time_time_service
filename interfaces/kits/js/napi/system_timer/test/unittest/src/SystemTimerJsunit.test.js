...
describe('TimerTest', function () {
    ...
    it('systemTimer_Timer_test1', 0, async () => {
        ...
        let timer = await systemTimer.createTimer(options)
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test31', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0100 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test32', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0200 start")
        var options = {
            type: TIMER_TYPE_WAKEUP,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test33', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0300 start")
        var options = {
            type: TIMER_TYPE_EXACT,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test34', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0400 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test35', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0500 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test36', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0600 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test37', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0700 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test38', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0800 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test39', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_0900 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test40', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1000 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: true,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test41', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1100 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test42', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1200 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: true,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test43', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1300 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test44', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1400 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test45', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1500 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test46', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1600 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test47', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1700 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test48', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1800 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test49', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_1900 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test50', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2000 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test51', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2100 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test52', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2200 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test53', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2300 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test54', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2400 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test55', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2500 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test56', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2600 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test57', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2700 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
     ...
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test58', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2800 start")
        var options = {
            type: TIMER_TYPE_REALTIME,
            repeat: false,
    ...
    /**
     * @tc.number    SUB_systemTimer_Timer_JS_API_2900
     * @tc.name      Test systemTimer.createTimer type = TIMER_TYPE_IDLE
     * @tc.desc      Test systemTimer_Timer API functionality.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
    it('systemTimer_Timer_test59', 0, async () => {
        console.log("SUB_systemTimer_Timer_JS_API_2900 start")
        var options = {
            type: TIMER_TYPE_IDLE,
            repeat: false,
